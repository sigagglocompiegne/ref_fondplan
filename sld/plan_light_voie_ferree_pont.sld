...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  ...
  <NamedLayer>
    <se:Name>plan_voie_ferree_pont</se:Name>
    <UserStyle>
      <se:Name>plan_voie_ferree_pont</se:Name>
...
<!-- ############ ECHELLE 1-10000 ############ -->
    ...
    <se:FeatureTypeStyle>
      <se:Rule>
        <se:Name>PONT VOIE FERREE TETE [E1:10000]</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
               <ogc:PropertyName>franchiss</ogc:PropertyName>
    ...
    <se:FeatureTypeStyle>
      <se:Rule>
        <se:Name>PONT VOIE FERREE [E1:10000]</se:Name>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
               <ogc:PropertyName>franchiss</ogc:PropertyName>
               <ogc:Literal>pont</ogc:Literal>
        ...
        <se:LineSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
         <se:Stroke>
           <se:SvgParameter name="stroke">#f8f4f0</se:SvgParameter>
